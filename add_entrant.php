        ...
        <table class="table table-sm table-responsive table-bordered">
            ...
            <tbody>
                <tr>
                    ...
                    <!-- <td><input class="form-control" type="text" name="sheet_number" id="sheet_number"></td> -->
                    <td>
                    ...
                    <!-- <td><input class="form-control" type="text" name="flow" id="flow"></td> -->
